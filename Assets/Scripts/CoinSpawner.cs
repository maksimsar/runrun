...
public sealed class CoinSpawner : MonoBehaviour
{
    ...
    private const float minSpawnInterval = 1.25f;
    ...
    public void UpdateSpawnSpeed()
    {
        ...
        float decreaseAmount = (difficulty.DifficultyLevel - 1) * 0.55f;
        modifiedInterval = Mathf.Max(minSpawnInterval, baseSpawnInterval - decreaseAmount);
    }
